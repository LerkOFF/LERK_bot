...
DISPOSABLE_FILE_PATH = os.getenv('DISPOSABLE_FILE_PATH')
RESPOND_CHANNEL_IDS = list(map(int, os.getenv('RESPOND_CHANNEL_IDS').split(',')))
CAN_GIVES_ROLES = os.getenv('CAN_GIVES_ROLES').split(',')
ROLE_GIVER_CHANNEL = int(os.getenv('ROLE_GIVER_CHANNEL'))
BOOSTY_ROLE_ID = int(os.getenv('BOOSTY_ROLE_ID'))
